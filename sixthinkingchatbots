...
client = OpenAI(api_key='YOUR KEY SHOULD BE HERE')
...
class sixThinkingChatbots():
  ...
  def __init__(self, problem_statement):
    ...
    self.white_response = callChatGPT(self.white_system_content, self.white_prompt)
    self.green_response = callChatGPT(self.green_system_content, self.green_prompt)
    self.yellow_response = callChatGPT(self.yellow_system_content, self.yellow_prompt)
    self.black_response = callChatGPT(self.black_system_content, self.black_prompt)
    self.red_response = callChatGPT(self.red_system_content, self.red_prompt)
  
    self.setPromptsOnlyBlue()
    self.blue_response = callChatGPT(self.blue_system_content, self.blue_prompt)
...
def callChatGPT(system_content, prompt):
